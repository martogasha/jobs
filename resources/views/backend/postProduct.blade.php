...
<head>
    <meta charset="utf-8" />
    <title>Post Product - Briden Jobs Alert</title>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="hs_blog_left_sidebar_main_wrapper">
                    <div class="row">
                        <form action="{{url('pProduct')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="inputAddress">Image One</label>
                                <input type="file" class="form-control" name="image">
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">Image Two</label>
                                <input type="file" class="form-control" name="imageOne">
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">Image Three</label>
                                <input type="file" class="form-control" name="imageTwo">
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">Image Four</label>
                                <input type="file" class="form-control" name="imageThree">
                            </div>
                            <div class="form-group">
