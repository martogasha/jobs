                            ...
                            <div class="hs_blog_box1_main_wrapper">
                                <div class="hs_blog_box1_cont_main_wrapper">
                                    <div class="hs_blog_cont_heading_wrapper">
                                        <a href="{{url('jobDetail')}}"><h2>Rahu Enters Cancer and Ketu Enters Capricorn.</h2></a>
                                        <h4><span></span></h4>
                                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit sequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet the
                                            ...
                                            <div class="comments">
                                                <div class="comment">
                                                    ...
                                                    <div class="text">
                                                        Really beautiful place, I really want to go back there and bring friends!
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="hs_footer_contact_wrapper">
                    ...
                    <p>Call Us <span>666 777 888</span> OR <span>111 222 333</span> Send an Email on <a href="#"><span class="__cf_email__" data-cfemail="beddd1d0cadfddcafedbc6dfd3ced2db90ddd1d3">[email&#160;protected]</span></a> Visit Us 123 Fake Street- London 12358
                        <br>United Kingdom</p>
